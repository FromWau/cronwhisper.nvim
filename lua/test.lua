...
describe("Parse minute", function()
    ...
    it("negative", function()
        ...
        assert.is_equal("Invalid minute value. Must be between 0 and 59.", error)
    end)
...
describe("Parse day of month", function()
    ...
    it("negative", function()
        ...
        local error = parsed.error
        assert.is_equal("Invalid day_of_month value. Must be between 1 and 31.", error)
    end)
...
describe("Parse month", function()
    ...
    it("negative", function()
        ...
        local error = parsed.error
        assert.is_equal("Invalid month value. Must be between 1 and 12.", error)
    end)
